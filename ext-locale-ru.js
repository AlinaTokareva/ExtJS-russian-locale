/**
 * Russian translation
 * By Alina Tokareva (utf-8 encoding)
 * 8 June 2021
 */
...
Ext.define("Ext.locale.ru.form.field.Time", {
    ...
    minText: "Время должно быть равно или больше {0}",
    maxText: "Время должно быть равно или меньше {0}",
    invalidText: "{0} - некорректное значение",
    format: "H:i",
...
Ext.define("Ext.locale.кг.grid.filters.filter.String", {
...
Ext.define("Ext.locale.ru.form.CheckboxGroup", {
    ...
    blankText: "Нужно выбрать хотя бы один элемент из группы"
});

Ext.define("Ext.locale.ru.form.RadioGroup", {
    override: "Ext.form.RadioGroup",
    blankText: "Нужно выбрать один элемент из группы"
});
...
Ext.define("Ext.locale.ru.grid.feature.Grouping", {
    ...
    expandTip: 'Кликните, чтобы развернуть',
    collapseTip: 'Кликните, чтобы свернуть'
});
